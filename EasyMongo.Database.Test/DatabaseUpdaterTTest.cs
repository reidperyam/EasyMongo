...
namespace EasyMongo.Database.Test
{
    ...
    public class DatabaseUpdaterTTest : IntegrationTestFixture
    {
        ...
        public void FindAndModifyAsyncTest1()
        {
            ...
            _databaseUpdaterT.FindAndModifyAsync(MONGO_COLLECTION_1_NAME, findAndModifyArgs);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndRemoveAsyncTest()
        {
            ...
            findAndRemoveArgs.Query = searchQuery;
            findAndRemoveArgs.SortBy = sortBy;
            _databaseUpdaterT.FindAndRemoveAsync(MONGO_COLLECTION_1_NAME, findAndRemoveArgs);
            _updaterAutoResetEvent.WaitOne();
