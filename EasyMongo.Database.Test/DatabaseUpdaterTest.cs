...
namespace EasyMongo.Database.Test
{
    ...
    public class DatabaseUpdaterTest : IntegrationTestFixture
    {
        ...
        public void FindAndModifyTest1()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndModify<Entry>(MONGO_COLLECTION_1_NAME, findAndModifyArgs);
        ...
        public void FindAndModifyTest2()
        {
            ...
            findAndModifyResult = _databaseUpdater.FindAndModify<Entry>(MONGO_COLLECTION_1_NAME, findAndModifyArgs);
        ...
        public void FindAndModifyAsyncTest1()
        {
            ...
            _databaseUpdater.FindAndModifyAsync<Entry>(MONGO_COLLECTION_1_NAME, findAndModifyArgs);
            _updaterAutoResetEvent.WaitOne();
