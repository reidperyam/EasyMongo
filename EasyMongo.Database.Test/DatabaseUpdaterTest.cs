...
namespace EasyMongo.Database.Test
{
    ...
    public class DatabaseUpdaterTest : IntegrationTestFixture
    {
        ...
        public void FindAndRemoveTest()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndRemove<Entry>(MONGO_COLLECTION_1_NAME, findAndRemoveArgs);
        ...
        public void FindAndRemoveAsyncTest()
        {
            ...
            findAndRemoveArgs.Query = searchQuery;
            findAndRemoveArgs.SortBy = sortBy;
            _databaseUpdater.FindAndRemoveAsync<Entry>(MONGO_COLLECTION_1_NAME, findAndRemoveArgs);
            _updaterAutoResetEvent.WaitOne();
