...
namespace EasyMongo.Database.Test
{
    ...
    public abstract class TestBase
    {
        ...
        public void Setup()
        {
            ...
            _reader = new Database.Reader<TestEntry>(MONGO_CONNECTION_STRING, MONGO_DATABASE_1_NAME);
            ...
            _writer = new Database.Writer<TestEntry>(MONGO_CONNECTION_STRING, MONGO_DATABASE_1_NAME);
            _writer.AsyncWriteCompleted += new WriteCompletedEvent(_writer_AsyncWriteCompleted);
            _updater = new Database.Updater<TestEntry>(MONGO_CONNECTION_STRING, MONGO_DATABASE_1_NAME);
