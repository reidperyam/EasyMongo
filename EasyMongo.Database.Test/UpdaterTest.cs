...
namespace EasyMongo.Database.Test
{
    ...
    public class UpdaterTest : IntegrationTestFixture
    {
        ...
        public void RemoveTest1()
        {
            ...
            _databaseUpdater.Remove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery);
        ...
        public void RemoveTest2()
        {
            ...
            _databaseUpdater.Remove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single);
            ...
            _databaseUpdater.Remove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None);
        ...
        public void RemoveTest3()
        {
            ...
            // remove entries with Message != entryMessage1
            _databaseUpdater.Remove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, _writeConcern);
        ...
        public void RemoveTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _databaseUpdater.Remove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single, _writeConcern);
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _databaseUpdater.Remove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None, _writeConcern);
        ...
        public void FindAndModifyTest1()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndModify<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update);
        ...
        public void FindAndModifyTest2()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndModify<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);

            findAndModifyResult = _databaseUpdater.FindAndModify<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, false);
        ...
        public void FindAndModifyTest3()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndModify<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);/*This should be populated as per the last argument to FindAndModify...*/

            findAndModifyResult = _databaseUpdater.FindAndModify<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, false);
        ...
        public void FindAndModifyTest4()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndModify<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, fields, true, true);
        ...
        public void FindAndRemoveTest()
        {
            ...
            var findAndModifyResult = _databaseUpdater.FindAndRemove<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy);
        ...
        public void RemoveAsyncTest1()
        {
            ...
            // remove entries with Message != entryMessage1
            _databaseUpdater.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery);
        ...
        public void RemoveAsyncTest2()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _databaseUpdater.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single);
            _updaterAutoResetEvent.WaitOne();
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _databaseUpdater.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void RemoveAsyncTest3()
        {
            ...
            // remove entries with Message != entryMessage1
            _databaseUpdater.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void RemoveAsyncTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _databaseUpdater.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _databaseUpdater.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest1()
        {
            ...
            _databaseUpdater.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest2()
        {
            ...
            _databaseUpdater.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _databaseUpdater.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest3()
        {
            ...
            _databaseUpdater.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _databaseUpdater.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest4()
        {
            ...
            var sortBy = SortBy.Descending("TimeStamp");
            IMongoFields fields = Fields.Include("TimeStamp");
            _databaseUpdater.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, fields, true, true);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndRemoveAsyncTest()
        {
            ...
            var sortBy = SortBy.Descending("TimeStamp");
            IMongoFields fields = Fields.Null;
            _databaseUpdater.FindAndRemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy);
            _updaterAutoResetEvent.WaitOne();
