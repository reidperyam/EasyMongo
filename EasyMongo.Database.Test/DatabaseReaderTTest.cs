...
namespace EasyMongo.Database.Test
{
    ...
    public class DatabaseReaderTTest : IntegrationTestFixture
    {
        ...
        public void ReadAsyncTest3()
        {
            ...
            _databaseReaderT.ReadAsync(_mongoDatabaseConnection.GetCollectionNames(), "Message", entryMessage);
            _readerAutoResetEvent.WaitOne();
            Assert.AreEqual(1, _asyncReadResults.Count());
            Assert.AreEqual(entryMessage, _asyncReadResults[0].Message);
        ...
        public void ReadAsyncTest4()
        {
            string entryMessage = "Hello World";
            AddMongoEntry(entryMessage, MONGO_COLLECTION_1_NAME);
            _databaseReaderT.ReadAsync(_mongoDatabaseConnection.GetCollectionNames(), "Message", entryMessage, "TimeStamp", _beforeTest, DateTime.Now);
            _readerAutoResetEvent.WaitOne();
            Assert.AreEqual(1, _asyncReadResults.Count());
            Assert.AreEqual(entryMessage, _asyncReadResults[0].Message);
        ...
        public void ReadAsyncTest6()
        {
            string entryMessage = "Hello World";
            AddMongoEntry(entryMessage, MONGO_COLLECTION_1_NAME);
            _databaseReaderT.ReadAsync(_mongoDatabaseConnection.GetCollectionNames(), "TimeStamp", _beforeTest, DateTime.Now);
            _readerAutoResetEvent.WaitOne();
            Assert.AreEqual(1, _asyncReadResults.Count());
            Assert.AreEqual(entryMessage, _asyncReadResults[0].Message);
        ...
        public void DistinctAsyncTest1()
        {
            ...
            _databaseReaderT.DistinctAsync<string>(MONGO_COLLECTION_1_NAME, "Message");
            _readerAutoResetEvent.WaitOne();
        ...
        public void DistinctAsyncTest2()
        {
            ...
            _databaseReaderT.DistinctAsync<string>(MONGO_COLLECTION_1_NAME, "Message", searchQuery);
            _readerAutoResetEvent.WaitOne();
        ...
        public void DistinctAsyncTest3()
        {
            ...
            _databaseReaderT.DistinctAsync<string>(collections, "Message");
            _readerAutoResetEvent.WaitOne();
        ...
        public void DistinctAsyncTest4()
        {
            ...
            _databaseReaderT.DistinctAsync<string>(collections, "Message", searchQuery);
            _readerAutoResetEvent.WaitOne();
