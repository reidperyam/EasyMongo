...
namespace EasyMongo.Database.Test
{
    ...
    public class DatabaseUpdaterTest : IntegrationTestFixture
    {
        ...
        public async void RemoveAsyncTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            WriteConcernResult result = await _databaseUpdater.RemoveAsync<Entry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single, _writeConcern);
        ...
        public async void FindAndModifyAsyncTest2()
        {
            ...
            result = await _databaseUpdater.FindAndModifyAsync<Entry>(MONGO_COLLECTION_1_NAME, findAndModifyArgs);
