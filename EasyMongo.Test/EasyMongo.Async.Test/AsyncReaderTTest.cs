...
namespace EasyMongo.Async.Test
{
    ...
    public class AsyncReaderTTest : IntegrationTestFixture
    {
        ...
        public async void ExecuteAndsTest1()
        {
            ...
            _results.AddRange(await _asyncReaderT.ExecuteAndsAsync(MONGO_COLLECTION_1_NAME, queries));
            Assert.AreEqual(1, _results.Count());
            Assert.AreEqual("Hello World 1", _results[0].Message);
        }
        ...
        public async void ExecuteOrsTest1()
        {
            ...
            _results.AddRange(await _asyncReaderT.ExecuteOrsAsync(MONGO_COLLECTION_1_NAME, queries));
