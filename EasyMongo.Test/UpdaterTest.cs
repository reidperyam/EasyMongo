...
namespace EasyMongo.Test
{
    ...
    public class UpdaterTest : TestBase
    {
        ...
        public void RemoveTest1()
        {
            ...
            _mongoUpdater.Remove(MONGO_COLLECTION_1_NAME, searchQuery);
        ...
        public void RemoveTest2()
        {
            ...
            _mongoUpdater.Remove(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single);
            ...
            _mongoUpdater.Remove(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None);
        ...
        public void RemoveTest3()
        {
            ...
            // remove entries with Message != entryMessage1
            _mongoUpdater.Remove(MONGO_COLLECTION_1_NAME, searchQuery, _writeConcern);
        ...
        public void RemoveTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _mongoUpdater.Remove(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single, _writeConcern);
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _mongoUpdater.Remove(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None, _writeConcern);
        ...
        public void FindAndModifyTest1()
        {
            ...
            var findAndModifyResult = _mongoUpdater.FindAndModify(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update);
        ...
        public void FindAndModifyTest2()
        {
            ...
            var findAndModifyResult = _mongoUpdater.FindAndModify(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);

            findAndModifyResult = _mongoUpdater.FindAndModify(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, false);
        ...
        public void FindAndModifyTest3()
        {
            ...
            var findAndModifyResult = _mongoUpdater.FindAndModify(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);/*This should be populated as per the last argument to FindAndModify...*/

            findAndModifyResult = _mongoUpdater.FindAndModify(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, false);
        ...
        public void FindAndModifyTest4()
        {
            ...
            var findAndModifyResult = _mongoUpdater.FindAndModify(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, fields, true, true);
        ...
        public void FindAndRemoveTest()
        {
            ...
            var findAndModifyResult = _mongoUpdater.FindAndRemove(MONGO_COLLECTION_1_NAME, searchQuery, sortBy);
