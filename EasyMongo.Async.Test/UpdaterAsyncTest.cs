...
namespace EasyMongo.Async.Test
{
    ...
    public class UpdaterAsyncTest : IntegrationTestFixture
    {
        ...
        public void RemoveTest1()
        {
            ...
            _updaterAsync.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery);
        ...
        public void RemoveTest2()
        {
            ...
            _updaterAsync.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single);
            _updaterAutoResetEvent.WaitOne();
            ...
            _updaterAsync.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void RemoveTest3()
        {
            ...
            // remove entries with Message != entryMessage1
            _updaterAsync.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void RemoveTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _updaterAsync.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.Single, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _updaterAsync.RemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, RemoveFlags.None, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyTest1()
        {
            ...
            _updaterAsync.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyTest2()
        {
            ...
            _updaterAsync.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _updaterAsync.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyTest3()
        {
            ...
            _updaterAsync.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _updaterAsync.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, true, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyTest4()
        {
            ...
            _updaterAsync.FindAndModifyAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy, update, fields, true, true);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndRemoveTest()
        {
            ...
            _updaterAsync.FindAndRemoveAsync<TestEntry>(MONGO_COLLECTION_1_NAME, searchQuery, sortBy);
            _updaterAutoResetEvent.WaitOne();
