...
namespace EasyMongo.Collection.Test
{
    ...
    public class UpdaterTest : TestBase
    {
        ...
        public void RemoveTest1()
        {
            ...
            List<TestEntry> results = new List<TestEntry>(_reader.Read("TimeStamp", _beforeTest, DateTime.Now));
            ...
            _updater.Remove(searchQuery);

            results = new List<TestEntry>(_reader.Read("TimeStamp", _beforeTest, DateTime.Now));
        ...
        public void RemoveTest2()
        {
            ...
            _updater.Remove(searchQuery, RemoveFlags.Single);
            ...
            _updater.Remove(searchQuery, RemoveFlags.None);
        ...
        public void RemoveTest3()
        {
            ...
            // remove entries with Message != entryMessage1
            _updater.Remove( searchQuery, _writeConcern);
        ...
        public void RemoveTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _updater.Remove(searchQuery, RemoveFlags.Single, _writeConcern);
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _updater.Remove(searchQuery, RemoveFlags.None, _writeConcern);
        ...
        public void FindAndModifyTest1()
        {
            ...
            var findAndModifyResult = _updater.FindAndModify(searchQuery, sortBy, update);
        ...
        public void FindAndModifyTest2()
        {
            ...
            var findAndModifyResult = _updater.FindAndModify(searchQuery, sortBy, update, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);

            findAndModifyResult = _updater.FindAndModify(searchQuery, sortBy, update, false);
        ...
        public void FindAndModifyTest3()
        {
            ...
            var findAndModifyResult = _updater.FindAndModify(searchQuery, sortBy, update, true, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);/*This should be populated as per the last argument to FindAndModify...*/

            findAndModifyResult = _updater.FindAndModify(searchQuery, sortBy, update, true, false);
        ...
        public void FindAndModifyTest4()
        {
            ...
            var findAndModifyResult = _updater.FindAndModify(searchQuery, sortBy, update, fields, true, true);
        ...
        public void FindAndRemoveTest()
        {
            ...
            var findAndModifyResult = _updater.FindAndRemove(searchQuery, sortBy);
        ...
        public void RemoveAsyncTest1()
        {
            ...
            // remove entries with Message != entryMessage1
            _updater.RemoveAsync(searchQuery);
        ...
        public void RemoveAsyncTest2()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _updater.RemoveAsync(searchQuery, RemoveFlags.Single);
            _updaterAutoResetEvent.WaitOne();
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _updater.RemoveAsync(searchQuery, RemoveFlags.None);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void RemoveAsyncTest3()
        {
            ...
            // remove entries with Message != entryMessage1
            _updater.RemoveAsync(searchQuery, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void RemoveAsyncTest4()
        {
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.Single means only one occurance matching searchQuery will be removed
            _updater.RemoveAsync(searchQuery, RemoveFlags.Single, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
            ...
            // remove entries with Message != entryMessage1
            // RemoveFlags.None means every occurance matching searchQuery will be removed
            _updater.RemoveAsync(searchQuery, RemoveFlags.None, _writeConcern);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest1()
        {
            ...
            _updater.FindAndModifyAsync(searchQuery, sortBy, update);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest2()
        {
            ...
            _updater.FindAndModifyAsync(searchQuery, sortBy, update, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _updater.FindAndModifyAsync(searchQuery, sortBy, update, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest3()
        {
            ...
            _updater.FindAndModifyAsync(searchQuery, sortBy, update, true, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _updater.FindAndModifyAsync(searchQuery, sortBy, update, true, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest4()
        {
            ...
            var sortBy = SortBy.Descending("TimeStamp");
            IMongoFields fields = Fields.Include("TimeStamp");
            _updater.FindAndModifyAsync(searchQuery, sortBy, update, fields, true, true);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndRemoveAsyncTest()
        {
            ...
            var sortBy = SortBy.Descending("TimeStamp");
            IMongoFields fields = Fields.Null;
            _updater.FindAndRemoveAsync(searchQuery, sortBy);
            _updaterAutoResetEvent.WaitOne();
