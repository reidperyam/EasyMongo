...
namespace EasyMongo.Collection.Test
{
    ...
    public class CollectionUpdaterTTest : IntegrationTestFixture
    {
        ...
        {
            _collectionUpdaterT = new CollectionUpdater<TestEntry>(_collectionUpdater);
        ...
        public void RemoveTest1()
        {
            ...
            List<TestEntry> results = new List<TestEntry>(_collectionReaderT.Read("TimeStamp", _beforeTest, DateTime.Now));
            ...
            results = new List<TestEntry>(_collectionReaderT.Read("TimeStamp", _beforeTest, DateTime.Now));
        ...
        public void FindAndModifyTest1()
        {
            ...
            var findAndModifyResult = _collectionUpdaterT.FindAndModify(searchQuery, sortBy, update);
        ...
        public void FindAndModifyTest2()
        {
            ...
            var findAndModifyResult = _collectionUpdaterT.FindAndModify(searchQuery, sortBy, update, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);

            findAndModifyResult = _collectionUpdaterT.FindAndModify(searchQuery, sortBy, update, false);
        ...
        public void FindAndModifyTest3()
        {
            ...
            var findAndModifyResult = _collectionUpdaterT.FindAndModify(searchQuery, sortBy, update, true, true);

            Assert.IsTrue(findAndModifyResult.Ok, "FindAndModifyResult from FindAndModify not OK");
            Assert.IsNull(findAndModifyResult.ErrorMessage);
            Assert.IsNotNull(findAndModifyResult.ModifiedDocument);/*This should be populated as per the last argument to FindAndModify...*/

            findAndModifyResult = _collectionUpdaterT.FindAndModify(searchQuery, sortBy, update, true, false);
        ...
        public void FindAndModifyTest4()
        {
            ...
            var findAndModifyResult = _collectionUpdaterT.FindAndModify(searchQuery, sortBy, update, fields, true, true);
        ...
        public void FindAndRemoveTest()
        {
            ...
            var findAndModifyResult = _collectionUpdaterT.FindAndRemove(searchQuery, sortBy);
        ...
        public void FindAndModifyAsyncTest1()
        {
            ...
            _collectionUpdaterT.FindAndModifyAsync(searchQuery, sortBy, update);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest2()
        {
            ...
            _collectionUpdaterT.FindAndModifyAsync(searchQuery, sortBy, update, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _collectionUpdaterT.FindAndModifyAsync(searchQuery, sortBy, update, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest3()
        {
            ...
            _collectionUpdaterT.FindAndModifyAsync(searchQuery, sortBy, update, true, true);
            _updaterAutoResetEvent.WaitOne();
            ...
            _collectionUpdaterT.FindAndModifyAsync(searchQuery, sortBy, update, true, false);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndModifyAsyncTest4()
        {
            ...
            var sortBy = SortBy.Descending("TimeStamp");
            IMongoFields fields = Fields.Include("TimeStamp");
            _collectionUpdaterT.FindAndModifyAsync(searchQuery, sortBy, update, fields, true, true);
            _updaterAutoResetEvent.WaitOne();
        ...
        public void FindAndRemoveAsyncTest()
        {
            ...
            var sortBy = SortBy.Descending("TimeStamp");
            IMongoFields fields = Fields.Null;
            _collectionUpdaterT.FindAndRemoveAsync(searchQuery, sortBy);
            _updaterAutoResetEvent.WaitOne();
