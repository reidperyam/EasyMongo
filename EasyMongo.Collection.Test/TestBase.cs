...
namespace EasyMongo.Collection.Test
{
    ...
    public abstract class TestBase
    {
        ...
        public void Setup()
        {
            ...
            IDatabaseUpdater<TestEntry> databaseUpdater = new Database.Updater<TestEntry>(MONGO_CONNECTION_STRING, MONGO_DATABASE_1_NAME);
            _updater = new Collection.Updater<TestEntry>(databaseUpdater, MONGO_COLLECTION_1_NAME);
